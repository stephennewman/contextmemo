...
const STEP_CONFIGS: Record<SetupStep, {
  ...
  extract: {
    ...
    progressMessages: [
      ...
      'Scanning subpages for additional context...',
      'Classifying content by topic area...',
      'Detecting technology stack mentions...',
      'Extracting integration and partnership references...',
      'Analyzing calls-to-action and conversion language...',
      'Mapping use cases from landing pages...',
      'Cross-referencing product claims with features...',
      'Identifying industry-specific terminology...',
      'Building brand context profile...',
      'Scoring confidence on extracted fields...',
