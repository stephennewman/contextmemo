...
export default async function AdminDashboardPage() {
  ...
  const brandStats = allBrands.map(brand => {
    ...
    return {
      ...
      aiSearchCrawls: Number(crawl?.ai_search_crawls) || 0,
      aiTrainingCrawls: Number(crawl?.ai_training_crawls) || 0,
      aiUserCrawls: Number(crawl?.ai_user_crawls) || 0,
