...
const MEMO_TYPE = 'alternative'
const ROUTE = '/alternatives'
const PAGE_TITLE = 'Alternatives'
const PAGE_DESCRIPTION = 'Explore alternatives to popular tools and platforms'
        ...
        <main className="max-w-3xl mx-auto px-6 py-12">
          ...
          {memos && memos.length > 0 ? (
            ...
            <div className="text-center py-16 bg-white rounded-xl border border-slate-200">
              ...
              <p className="text-slate-500">No alternatives published yet.</p>
            </div>
          )}
        </main>
