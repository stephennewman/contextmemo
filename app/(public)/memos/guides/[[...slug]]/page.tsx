...
const MEMO_TYPES = ['guide', 'industry']
const ROUTE = '/memos/guides'
const PAGE_TITLE = 'Guides'
const PAGE_DESCRIPTION = 'Educational content explaining GEO concepts, AI search optimization, and brand visibility strategies.'
...
export default async function GuidesPage({ params }: Props) {
  ...
  // Index page - show all guide memos
  if (!slugPath) {
