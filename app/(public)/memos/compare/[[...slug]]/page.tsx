...
const MEMO_TYPES = ['comparison', 'alternative']
const ROUTE = '/memos/compare'
const PAGE_TITLE = 'Comparisons'
const PAGE_DESCRIPTION = 'Side-by-side analysis of GEO tools, AI search strategies, and optimization approaches.'
