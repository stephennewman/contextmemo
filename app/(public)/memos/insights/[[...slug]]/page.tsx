...
const MEMO_TYPES = ['product_deploy']
const ROUTE = '/memos/insights'
const PAGE_TITLE = 'Product Insights'
const PAGE_DESCRIPTION = 'AI visibility insights derived from real product development — what we shipped and why it matters'
        ...
        <main className="max-w-4xl mx-auto px-6 py-12">
          ...
          {memos && memos.length > 0 ? (
            ...
            <div className="text-center py-16 bg-white/5 border-2 border-white/10">
              ...
              <p className="text-slate-500">No insights published yet.</p>
            </div>
          )}
        </main>
