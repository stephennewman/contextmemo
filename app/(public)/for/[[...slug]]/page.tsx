...
const MEMO_TYPE = 'industry'
const ROUTE = '/for'
const PAGE_TITLE = 'Industries'
const PAGE_DESCRIPTION = 'AI visibility solutions tailored for your industry'
        ...
        <main className="max-w-3xl mx-auto px-6 py-12">
          ...
          {memos && memos.length > 0 ? (
            ...
            <div className="text-center py-16 bg-white rounded-xl border border-slate-200">
              ...
              <p className="text-slate-500">No industry content published yet.</p>
            </div>
          )}
        </main>
